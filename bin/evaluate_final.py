...
def evaluate_file(test_mode, model_name, pred_file):
    ...
    if 'LPO' == test_mode or 'LCO' == test_mode:
        norm_drug_eval_results, evaluation_results_per_drug = evaluate_per_group(df=true_vs_pred,
                                                                                 group_by='drug',
    ...
    if 'LPO' == test_mode or 'LDO' == test_mode:
        norm_cl_eval_results, evaluation_results_per_cl = evaluate_per_group(df=true_vs_pred,
                                                                             group_by='cell_line',
...
if __name__ == "__main__":
    ...
    results_all, eval_res_d, eval_res_cl, t_vs_pred, mname = evaluate_file(args.test_mode, args.model_name, args.pred_file)
